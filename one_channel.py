...
IMU_controller.setEulerAngleDecompositionOrder(0)
...
IMU_subject.setEulerAngleDecompositionOrder(0)
...
while running:
    command = raw_input('Press ENTER to stop, a to increase current, z to decrease:')
    if command == 'a':
        current[0] += 2
    elif command == 'z':
        current[0] -= 2
